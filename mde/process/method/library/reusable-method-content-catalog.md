...
The consolidated repository contains 17 RoleDefinitions, 139 TaskDefinitions, 96 WorkProductDefinitions, and 46 Guidance elements. Stable identifiers are shown because the delivery processes refer to these definitions through RoleUse, TaskUse, WorkProductUse, and ProcessParameter elements. “Provenance” identifies the source component from which an element was consolidated.
...
Conceptual role mapping: `R-12`. Provenance: End-to-end lifecycle, Engineered core content.
...
Conceptual role mapping: `R-16`. Provenance: End-to-end lifecycle, Engineered core content.
...
Conceptual role mapping: `R-01`. Provenance: End-to-end lifecycle, Engineered core content.

## Task definitions

### End-to-end lifecycle (37 tasks)

#### Review SLOs, telemetry, cost, and product outcomes (`task.e2e.ops.a1.t1`)

Review SLOs, telemetry, cost, and product outcomes. Its primary performer is `role.service-owner`; supporting performers are `role.product-owner`, `role.security-engineer`, `role.finops-cost-analyst`. It consumes `e2e-artifact.release-record`, `e2e-artifact.product-charter`, `e2e-artifact.operations-record`, `e2e-artifact.method-profile`, `e2e-artifact.service-flow-system`, `e2e-artifact.cost-model` and produces or updates `e2e-artifact.operations-record`, `e2e-artifact.operational-work-item`, `e2e-artifact.cost-model`.

**Work.**

- Inspect service levels, errors, cost, security signals, usage, provider events, and product outcome measures.
- Compare observations with the service, product, forecast, budget, and unit-cost hypotheses.
- Capture actionable demand as visible service work items rather than inserting hidden work into a release plan.

**Exit.** Review SLOs, telemetry, cost, and product outcomes evidence is recorded.
...
Perform problem and risk learning. Its primary performer is `role.quality-engineer`; supporting performers are `role.service-owner`, `role.security-engineer`, `role.method-engineer`. It consumes `e2e-artifact.operational-work-item`, `e2e-artifact.service-flow-system`, `e2e-artifact.operations-record`, `e2e-artifact.increment-record`, `e2e-artifact.release-record`, `e2e-artifact.method-profile`, `e2e-artifact.risk-register`, `e2e-artifact.improvement-record` and produces or updates `e2e-artifact.operations-record`, `e2e-artifact.method-profile`, `e2e-artifact.operational-work-item`, `e2e-artifact.risk-register`, `e2e-artifact.improvement-record`.

**Work.**

- Analyze contributing causes across requirements, models, transformation, generation, deployment, and operation.
- Update controls, tests, model patterns, risk treatment, process guidance, or method profile as appropriate.
...
#### Inspect flow, quality, cost, and coordination metrics (`task.e2e.ops.a5.t1`)

Inspect flow, quality, cost, and coordination metrics. Its primary performer is `role.process-reviewer`; supporting performers are `role.delivery-lead`, `role.method-engineer`, `role.finops-cost-analyst`, `role.service-owner`. It consumes `e2e-artifact.operational-work-item`, `e2e-artifact.service-flow-system`, `e2e-artifact.increment-record`, `e2e-artifact.operations-record`, `e2e-artifact.product-charter`, `e2e-artifact.method-profile`, `e2e-artifact.release-record`, `e2e-artifact.cost-model`, `e2e-artifact.improvement-record` and produces or updates `e2e-artifact.operations-record`, `e2e-artifact.method-profile`, `e2e-artifact.service-flow-system`, `e2e-artifact.cost-model`, `e2e-artifact.improvement-record`.

**Work.**

- Review planned-delivery forecast, Kanban WIP, throughput, cycle time, work-item age, SLE attainment, demand arrival rate, expedite frequency, rework, trace coverage, blockers, dependency age, escaped defects, cost/unit trends, and product outcomes.
...
- Approve bounded changes to the Definition of Workflow, capacity policy, DevOps interface, cost guardrails, or method profile and record their expected effect.

**Exit.** Inspect flow, quality, cost, and coordination metrics evidence is recorded.
...
Plan the vertical increment. Its primary performer is `role.product-owner`; supporting performers are `role.delivery-lead`, `role.requirements-engineer`, `role.domain-expert`, `role.finops-cost-analyst`. It consumes `e2e-artifact.product-charter`, `e2e-artifact.method-profile`, `e2e-artifact.team-topology`, `e2e-artifact.cost-model`, `e2e-artifact.risk-register` and produces or updates `e2e-artifact.increment-record`, `e2e-artifact.risk-register`.

**Work.**

- Select scope from the ordered product backlog.
- Define outcome, acceptance criteria, dependencies, risks, cost hypothesis, and expected model/artifact evidence.
- Assign scope items to owning teams and establish the increment ledger.

**Exit.** Increment scope, owners, acceptance evidence, dependencies, and cost-sensitive assumptions are agreed.
...
Run the CIM increment. Its primary performer is `role.business-modeler`; supporting performers are `role.requirements-engineer`, `role.domain-expert`, `role.product-owner`, `role.security-engineer`. It consumes `e2e-artifact.increment-record`, `e2e-artifact.product-charter`, `e2e-artifact.method-profile`, `e2e-artifact.team-topology` and produces or updates `e2e-artifact.increment-record`.
...
Execute and inspect CIM-to-PIM transformation. Its primary performer is `role.solution-architect`. It consumes `e2e-artifact.increment-record`, `e2e-artifact.method-profile`, `e2e-artifact.product-charter` and produces or updates `e2e-artifact.increment-record`.
...
Run the PIM increment. Its primary performer is `role.solution-architect`; supporting performers are `role.security-engineer`, `role.quality-engineer`, `role.cloud-platform-engineer`, `role.service-owner`, `role.finops-cost-analyst`. It consumes `e2e-artifact.increment-record`, `e2e-artifact.product-charter`, `e2e-artifact.method-profile` and produces or updates `e2e-artifact.increment-record`, `e2e-artifact.risk-register`.

**Work.**

- Execute the PIM process for the transformed slice.
- Review contracts, data access, integration, policy, platform mapping, cost drivers, and operational assumptions.
...
Execute and inspect PIM-to-PSM transformation. Its primary performer is `role.cloud-platform-engineer`. It consumes `e2e-artifact.increment-record`, `e2e-artifact.method-profile`, `e2e-artifact.product-charter` and produces or updates `e2e-artifact.increment-record`.
...
Run the PSM increment. Its primary performer is `role.cloud-platform-engineer`; supporting performers are `role.solution-architect`, `role.security-engineer`, `role.quality-engineer`, `role.release-engineer`, `role.service-owner`, `role.finops-cost-analyst`. It consumes `e2e-artifact.increment-record`, `e2e-artifact.method-profile`, `e2e-artifact.product-charter` and produces or updates `e2e-artifact.increment-record`, `e2e-artifact.cost-model`, `e2e-artifact.risk-register`.
...
Generate and fingerprint the artifact baseline. Its primary performer is `role.cloud-platform-engineer`. It consumes `e2e-artifact.increment-record`, `e2e-artifact.method-profile`, `e2e-artifact.team-topology` and produces or updates `e2e-artifact.increment-record`.
...
Run artifact readiness and accept the increment. Its primary performer is `role.process-reviewer`; supporting performers are `role.product-owner`, `role.quality-engineer`, `role.security-engineer`, `role.service-owner`, `role.finops-cost-analyst`. It consumes `e2e-artifact.increment-record`, `e2e-artifact.method-profile`, `e2e-artifact.product-charter`, `e2e-artifact.cost-model`, `e2e-artifact.risk-register` and produces or updates `e2e-artifact.increment-record`.

**Work.**

- Execute the artifact deployment-readiness process for the generated candidate.
- Review verification, security, cost, rollback, operational, and acceptance evidence.
...
#### Review the increment and adapt the way of working (`task.e2e.p7.artifact-completion.t2`)

Review the increment and adapt the way of working. Its primary performer is `role.method-engineer`; supporting performers are `role.delivery-lead`, `role.process-reviewer`, `role.product-owner`. It consumes `e2e-artifact.increment-record`, `e2e-artifact.method-profile`, `e2e-artifact.cost-model`, `e2e-artifact.risk-register`, `e2e-artifact.improvement-record` and produces or updates `e2e-artifact.increment-record`, `e2e-artifact.method-profile`, `e2e-artifact.improvement-record`.

**Work.**

- Compare outcome, effort, queue time, rework, trace, cost, dependency, and finding evidence with the increment hypothesis.
- Identify useful practices, avoidable burden, missing guidance, and candidate reusable assets.
- Update the method profile, improvement record, owners, and experiment/review dates; record a reasoned no-op when no change is justified.

**Exit.** The increment retrospective has an owned improvement decision or a reasoned no-op.

**Checks.** A local workaround is not generalized without its context and evidence.

#### Define product outcomes and success measures (`task.e2e.ph0.st1.t1`)

Define product outcomes and success measures. Its primary performer is `role.product-owner`; supporting performers are `role.sponsor`, `role.domain-expert`, `role.service-owner`. It consumes None declared and produces or updates `e2e-artifact.product-charter`.

**Work.**

- State the user or mission problem and desired outcomes.
- Define measurable product, operational, security, quality, and cost/value outcomes.
- Record assumptions, constraints, non-goals, expected lifetime, exit conditions, and the first release hypothesis.
...
Establish the initial release and increment hypothesis. Its primary performer is `role.requirements-engineer`; supporting performers are `role.product-owner`, `role.domain-expert`, `role.solution-architect`, `role.delivery-lead`. It consumes `e2e-artifact.product-charter` and produces or updates `e2e-artifact.product-charter`, `e2e-artifact.increment-record`.
...
#### Assess feasibility and serverless suitability (`task.e2e.ph0.st1a.t1`)

Assess feasibility and serverless suitability. Its primary performer is `role.solution-architect`; supporting performers are `role.product-owner`, `role.domain-expert`, `role.cloud-platform-engineer`, `role.security-engineer`, `role.quality-engineer`, `role.service-owner`, `role.finops-cost-analyst`. It consumes `e2e-artifact.product-charter` and produces or updates `e2e-artifact.serverless-suitability`, `e2e-artifact.risk-register`.

**Work.**

- Compare serverless, hybrid, and non-serverless alternatives against workload shape, latency, state, integration, availability, compliance, skills, operations, portability, and exit constraints.
- Use bounded architecture experiments for material uncertainty and record provider assumptions separately from platform-independent intent.
- Record the recommended direction, rejected alternatives, residual risks, and review triggers.

**Exit.** Assess feasibility and serverless suitability evidence is recorded.

**Checks.** The recommendation compares credible alternatives rather than assuming serverless. Material uncertainty has an owner and an experiment or decision deadline.

#### Establish cost model and budget guardrails (`task.e2e.ph0.st1a.t2`)

Establish cost model and budget guardrails. Its primary performer is `role.finops-cost-analyst`; supporting performers are `role.product-owner`, `role.solution-architect`, `role.cloud-platform-engineer`, `role.service-owner`. It consumes `e2e-artifact.product-charter`, `e2e-artifact.serverless-suitability` and produces or updates `e2e-artifact.cost-model`, `e2e-artifact.risk-register`.

**Work.**

- Model demand drivers and scenario ranges for requests, duration, memory, data transfer, storage, logs, workflows, and external services.
- Define allocation tags, business unit-cost metrics, budget/forecast ranges, anomaly thresholds, and confidence assumptions.
- Identify cost-sensitive architecture decisions and the runtime evidence needed to recalibrate estimates.

**Exit.** Establish cost model and budget guardrails evidence is recorded.

**Checks.** The estimate states workload assumptions, range, confidence, owner, and review cadence. At least one business unit-cost measure links technology spend to product value.

#### Authorize pursue, explore, redirect, or stop at G0 (`task.e2e.ph0.st1a.t3`)

Authorize pursue, explore, redirect, or stop at G0. Its primary performer is `role.sponsor`; supporting performers are `role.product-owner`, `role.solution-architect`, `role.security-engineer`, `role.service-owner`, `role.finops-cost-analyst`. It consumes `e2e-artifact.product-charter`, `e2e-artifact.serverless-suitability`, `e2e-artifact.cost-model`, `e2e-artifact.risk-register` and produces or updates `e2e-artifact.product-charter`, `e2e-artifact.serverless-suitability`, `e2e-artifact.cost-model`, `e2e-artifact.risk-register`.

**Work.**

- Review the product value case, suitability recommendation, cost range, material risks, and proposed experiments.
- Record one explicit G0 decision: pursue, explore, redirect, or stop.
- For pursue or explore, record funding/time boundaries, decision owners, and conditions that trigger reconsideration.

**Exit.** An authorized G0 decision and its conditions are recorded.

**Checks.** Silence or task completion is not authorization. A stop or redirect decision preserves the rationale and evidence.

#### Assess context and process-tailoring risks (`task.e2e.ph0.st2.t1`)

Assess context and process-tailoring risks. Its primary performer is `role.method-engineer`; supporting performers are `role.delivery-lead`, `role.process-reviewer`. It consumes `e2e-artifact.product-charter`, `e2e-artifact.increment-record` and produces or updates `e2e-artifact.method-profile`, `e2e-artifact.risk-register`.
...
Define the tailored Definition of Ready and Done. Its primary performer is `role.process-reviewer`; supporting performers are `role.method-engineer`, `role.quality-engineer`, `role.security-engineer`, `role.service-owner`. It consumes `e2e-artifact.method-profile`, `e2e-artifact.product-charter`, `e2e-artifact.increment-record` and produces or updates `e2e-artifact.method-profile`.

**Work.**

- Define entry and exit evidence for model slices, transformations, release candidates, operations, and retirement.
- Define which findings are blocking, who may accept residual risk, and how time-bound risk acceptance works.
...
Define team ownership and interfaces. Its primary performer is `role.delivery-lead`; supporting performers are `role.product-owner`, `role.method-engineer`. It consumes `e2e-artifact.method-profile`, `e2e-artifact.product-charter` and produces or updates `e2e-artifact.team-topology`.
...
Set coordination cadence and escalation paths. Its primary performer is `role.delivery-lead`. It consumes `e2e-artifact.team-topology`, `e2e-artifact.method-profile`, `e2e-artifact.product-charter` and produces or updates `e2e-artifact.team-topology`, `e2e-artifact.method-profile`.
...
Define quality and security control objectives. Its primary performer is `role.security-engineer`; supporting performers are `role.quality-engineer`, `role.service-owner`, `role.records-data-steward`. It consumes `e2e-artifact.team-topology`, `e2e-artifact.method-profile`, `e2e-artifact.product-charter`, `e2e-artifact.risk-register` and produces or updates `e2e-artifact.method-profile`, `e2e-artifact.risk-register`.

**Work.**

- Identify privacy, threat, compliance, resilience, performance, accessibility, audit, cost, and records obligations.
...
Define operational and release strategy. Its primary performer is `role.service-owner`; supporting performers are `role.release-engineer`, `role.finops-cost-analyst`, `role.records-data-steward`, `role.security-engineer`. It consumes `e2e-artifact.method-profile`, `e2e-artifact.team-topology`, `e2e-artifact.product-charter`, `e2e-artifact.cost-model`, `e2e-artifact.risk-register` and produces or updates `e2e-artifact.product-charter`, `e2e-artifact.method-profile`, `e2e-artifact.service-flow-system`.

**Work.**

- Define environments, support ownership, SLO hypotheses, observability expectations, cost signals, rollback posture, and release cadence.
...
- Identify data migration, compatibility, records/retention, and progressive-delivery constraints and record the initial release decision policy.
...
Approve retirement scope and plan. Its primary performer is `role.product-owner`; supporting performers are `role.sponsor`, `role.service-owner`, `role.security-engineer`, `role.finops-cost-analyst`, `role.records-data-steward`. It consumes `e2e-artifact.operations-record`, `e2e-artifact.release-record`, `e2e-artifact.product-charter`, `e2e-artifact.method-profile`, `e2e-artifact.cost-model`, `e2e-artifact.risk-register` and produces or updates `e2e-artifact.retirement-record`, `e2e-artifact.risk-register`.

**Work.**

- Confirm business, technical, legal, security, financial, records, and operational reasons for retirement.
- Define replacement, user communication, compatibility, rollback, retention/export/deletion, and exit criteria.
- Assign owners and schedule decision checkpoints.

**Exit.** Approve retirement scope and plan evidence is recorded.

**Checks.** The plan identifies affected stakeholders, dependencies, records obligations, and irreversible actions.

#### Execute migration and data disposition (`task.e2e.ph2.st2.t1`)

Execute migration and data disposition. Its primary performer is `role.cloud-platform-engineer`; supporting performers are `role.records-data-steward`, `role.security-engineer`, `role.service-owner`. It consumes `e2e-artifact.retirement-record`, `e2e-artifact.operations-record`, `e2e-artifact.release-record`, `e2e-artifact.method-profile` and produces or updates `e2e-artifact.retirement-record`.
...
#### Decommission service, access, and cost surfaces (`task.e2e.ph2.st2.t2`)

Decommission service, access, and cost surfaces. Its primary performer is `role.service-owner`; supporting performers are `role.cloud-platform-engineer`, `role.security-engineer`, `role.finops-cost-analyst`, `role.records-data-steward`. It consumes `e2e-artifact.retirement-record`, `e2e-artifact.operations-record`, `e2e-artifact.release-record`, `e2e-artifact.team-topology`, `e2e-artifact.cost-model` and produces or updates `e2e-artifact.retirement-record`, `e2e-artifact.cost-model`.
...
#### Verify records retention and data disposition (`task.e2e.ph2.st2.t3`)

Verify records retention and data disposition. Its primary performer is `role.records-data-steward`; supporting performers are `role.security-engineer`, `role.service-owner`, `role.cloud-platform-engineer`. It consumes `e2e-artifact.retirement-record`, `e2e-artifact.operations-record`, `e2e-artifact.method-profile` and produces or updates `e2e-artifact.retirement-record`.
...
**Checks.** Every governed data set has disposition evidence and a custodian. G8 is blocked by an unowned retention, deletion, or legal-hold obligation.

#### Complete closure review (`task.e2e.ph2.st3.t1`)

Complete closure review. Its primary performer is `role.process-reviewer`; supporting performers are `role.sponsor`, `role.product-owner`, `role.service-owner`, `role.finops-cost-analyst`, `role.records-data-steward`, `role.method-engineer`. It consumes `e2e-artifact.retirement-record`, `e2e-artifact.operations-record`, `e2e-artifact.product-charter`, `e2e-artifact.increment-record`, `e2e-artifact.method-profile`, `e2e-artifact.release-record`, `e2e-artifact.cost-model`, `e2e-artifact.improvement-record` and produces or updates `e2e-artifact.retirement-record`, `e2e-artifact.method-profile`, `e2e-artifact.cost-model`, `e2e-artifact.improvement-record`.

**Work.**

- Confirm retirement exit criteria, financial closure, records, and custodians are complete.
...
- Review product, architecture, operational, economic, and process outcomes.
...
Assemble the release candidate. Its primary performer is `role.release-engineer`. It consumes `e2e-artifact.increment-record`, `e2e-artifact.product-charter`, `e2e-artifact.method-profile`, `e2e-artifact.team-topology` and produces or updates `e2e-artifact.release-record`.
...
Review release evidence and go/no-go criteria. Its primary performer is `role.process-reviewer`; supporting performers are `role.product-owner`, `role.quality-engineer`, `role.security-engineer`, `role.service-owner`, `role.finops-cost-analyst`. It consumes `e2e-artifact.release-record`, `e2e-artifact.increment-record`, `e2e-artifact.product-charter`, `e2e-artifact.method-profile`, `e2e-artifact.cost-model`, `e2e-artifact.risk-register` and produces or updates `e2e-artifact.release-record`, `e2e-artifact.cost-model`, `e2e-artifact.risk-register`.
...
Deploy and validate progressively. Its primary performer is `role.release-engineer`; supporting performers are `role.quality-engineer`, `role.security-engineer`, `role.service-owner`, `role.finops-cost-analyst`. It consumes `e2e-artifact.release-record`, `e2e-artifact.product-charter`, `e2e-artifact.method-profile`, `e2e-artifact.team-topology` and produces or updates `e2e-artifact.release-record`.

**Work.**

- Deploy the exact candidate to the approved environment sequence.
- Run smoke, functional, security, data, observability, cost-signal, and compatibility checks.
...
Complete handover and rollback rehearsal. Its primary performer is `role.service-owner`; supporting performers are `role.release-engineer`, `role.security-engineer`, `role.finops-cost-analyst`. It consumes `e2e-artifact.release-record`, `e2e-artifact.product-charter`, `e2e-artifact.method-profile`, `e2e-artifact.team-topology` and produces or updates `e2e-artifact.release-record`, `e2e-artifact.operations-record`.
...
Review release outcome and update roadmap. Its primary performer is `role.product-owner`; supporting performers are `role.service-owner`, `role.finops-cost-analyst`, `role.method-engineer`, `role.delivery-lead`. It consumes `e2e-artifact.release-record`, `e2e-artifact.operations-record`, `e2e-artifact.product-charter`, `e2e-artifact.increment-record`, `e2e-artifact.method-profile`, `e2e-artifact.cost-model`, `e2e-artifact.improvement-record` and produces or updates `e2e-artifact.release-record`, `e2e-artifact.product-charter`, `e2e-artifact.increment-record`, `e2e-artifact.cost-model`, `e2e-artifact.improvement-record`.

**Work.**

- Compare product, operational, and unit-cost outcomes with the release hypothesis.
- Accept outcomes, revise priorities, and create follow-up increments for gaps.
- Record decisions and changes to scope, measures, estimates, and assumptions.

**Exit.** Review release outcome and update roadmap evidence is recorded.

**Checks.** Outcome learning changes a backlog, product decision, cost forecast, or explicitly confirms the hypothesis.

### CIM modeling component (26 tasks)

#### Create CIM model root (`task.cim.ph1.st1.t1`)

Create CIM model root. Its primary performer is `role.business-modeler`. It consumes None declared and produces or updates `cim-artifact.model-root`.
...
Establish shared model contract and evidence conventions. Its primary performer is `role.method-engineer`. It consumes `cim-artifact.model-root` and produces or updates `cim-artifact.model-root`.
...
Plan capability slice. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.model-root` and produces or updates `cim-artifact.increment-plan`.
...
Define business goals and KPIs. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.increment-plan` and produces or updates `cim-artifact.strategic-intent`.
...
Identify stakeholders. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.strategic-intent`, `cim-artifact.increment-plan` and produces or updates `cim-artifact.strategic-intent`.
...
Model actors and roles. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.strategic-intent`, `cim-artifact.increment-plan` and produces or updates `cim-artifact.participation-model`.
...
Register external systems. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.participation-model`, `cim-artifact.strategic-intent` and produces or updates `cim-artifact.participation-model`.
...
Map business capabilities. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.participation-model`, `cim-artifact.strategic-intent` and produces or updates `cim-artifact.capability-map`.
...
Record capability dependencies. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.capability-map`, `cim-artifact.strategic-intent` and produces or updates `cim-artifact.capability-map`.
...
Define domain glossary. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.capability-map`, `cim-artifact.strategic-intent` and produces or updates `cim-artifact.glossary`.
...
Define data classifications. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.glossary`, `cim-artifact.strategic-intent` and produces or updates `cim-artifact.information-taxonomy`.
...
Create information items. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.information-taxonomy`, `cim-artifact.glossary` and produces or updates `cim-artifact.information-taxonomy`.
...
Model domain entities. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.information-taxonomy`, `cim-artifact.glossary`, `cim-artifact.capability-map` and produces or updates `cim-artifact.domain-structure`.
...
Model value objects and relationships. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.domain-structure`, `cim-artifact.information-taxonomy` and produces or updates `cim-artifact.domain-structure`.
...
Model commands and outcomes. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.domain-structure`, `cim-artifact.participation-model`, `cim-artifact.capability-map` and produces or updates `cim-artifact.behavior-surface`.
...
Model queries. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.behavior-surface`, `cim-artifact.information-taxonomy`, `cim-artifact.participation-model` and produces or updates `cim-artifact.behavior-surface`.
...
Model events, errors, and conditions. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.behavior-surface`, `cim-artifact.domain-structure`, `cim-artifact.participation-model` and produces or updates `cim-artifact.behavior-surface`.
...
Define aggregate candidates. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.behavior-surface`, `cim-artifact.domain-structure`, `cim-artifact.capability-map` and produces or updates `cim-artifact.aggregate-model`.
...
Model business processes. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.behavior-surface`, `cim-artifact.domain-structure`, `cim-artifact.strategic-intent`, `cim-artifact.aggregate-model` and produces or updates `cim-artifact.process-model`.
...
Define policies and decision tables. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.process-model`, `cim-artifact.behavior-surface`, `cim-artifact.domain-structure` and produces or updates `cim-artifact.decision-model`.
...
Synthesize bounded contexts. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.capability-map`, `cim-artifact.domain-structure`, `cim-artifact.behavior-surface`, `cim-artifact.process-model`, `cim-artifact.decision-model` and produces or updates `cim-artifact.context-map`.
...
Formalize requirements. Its primary performer is `role.requirements-engineer`. It consumes `cim-artifact.strategic-intent`, `cim-artifact.domain-structure`, `cim-artifact.behavior-surface`, `cim-artifact.context-map`, `cim-artifact.decision-model` and produces or updates `cim-artifact.requirements-package`.
...
Record transformation metadata. Its primary performer is `role.business-modeler`. It consumes `cim-artifact.governance-package`, `cim-artifact.requirements-package`, `cim-artifact.context-map`, `cim-artifact.domain-structure`, `cim-artifact.decision-model` and produces or updates `cim-artifact.transformation-contract`.
...
Review and adapt CIM increment. Its primary performer is `role.process-reviewer`. It consumes `cim-artifact.trace-readiness`, `cim-artifact.strategic-intent`, `cim-artifact.increment-plan`, `cim-artifact.requirements-package`, `cim-artifact.governance-package` and produces or updates `cim-artifact.increment-review`.
...
Plan service slice. Its primary performer is `role.solution-architect`. It consumes None declared and produces or updates `pim-artifact.increment-plan`.
...
Create PIM model root. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.increment-plan` and produces or updates `pim-artifact.architecture-posture`.
...
Set architecture posture. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.architecture-posture`, `pim-artifact.increment-plan` and produces or updates `pim-artifact.architecture-posture`.
...
Establish shared model contract and evidence conventions. Its primary performer is `role.method-engineer`. It consumes `pim-artifact.architecture-posture`, `pim-artifact.increment-plan` and produces or updates `pim-artifact.architecture-posture`.
...
Define serverless services. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.architecture-posture`, `pim-artifact.increment-plan` and produces or updates `pim-artifact.service-map`.
...
Assign element memberships. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.service-map`, `pim-artifact.architecture-posture` and produces or updates `pim-artifact.service-map`.
...
Define schemas and fields. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.service-map`, `pim-artifact.architecture-posture`, `pim-artifact.increment-plan` and produces or updates `pim-artifact.contract-catalog`.
...
Model event types and envelopes. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.contract-catalog`, `pim-artifact.service-map` and produces or updates `pim-artifact.contract-catalog`.
...
Model data stores and models. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.contract-catalog`, `pim-artifact.service-map`, `pim-artifact.architecture-posture` and produces or updates `pim-artifact.data-architecture`.
...
Define access patterns and indexes. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.data-architecture`, `pim-artifact.contract-catalog`, `pim-artifact.service-map` and produces or updates `pim-artifact.data-architecture`.
...
Configure change streams and notifications. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.data-architecture`, `pim-artifact.contract-catalog`, `pim-artifact.service-map` and produces or updates `pim-artifact.data-architecture`.
...
Define functions and contracts. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.data-architecture`, `pim-artifact.service-map`, `pim-artifact.contract-catalog` and produces or updates `pim-artifact.compute-catalog`.
...
Configure triggers and runtime. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.compute-catalog`, `pim-artifact.contract-catalog` and produces or updates `pim-artifact.compute-catalog`.
...
Define APIs and routes. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.compute-catalog`, `pim-artifact.contract-catalog`, `pim-artifact.service-map` and produces or updates `pim-artifact.api-catalog`.
...
Map API contracts and errors. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.api-catalog`, `pim-artifact.contract-catalog`, `pim-artifact.compute-catalog` and produces or updates `pim-artifact.api-catalog`.
...
Model event channels and buses. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.api-catalog`, `pim-artifact.contract-catalog`, `pim-artifact.compute-catalog`, `pim-artifact.service-map` and produces or updates `pim-artifact.integration-topology`.
...
Define flows and routing rules. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.integration-topology`, `pim-artifact.api-catalog`, `pim-artifact.contract-catalog`, `pim-artifact.compute-catalog` and produces or updates `pim-artifact.integration-topology`.
...
Model workflows and states. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.integration-topology`, `pim-artifact.service-map`, `pim-artifact.api-catalog`, `pim-artifact.contract-catalog` and produces or updates `pim-artifact.workflow-model`.
...
Configure human tasks and error handling. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.workflow-model`, `pim-artifact.integration-topology`, `pim-artifact.service-map`, `pim-artifact.api-catalog`, `pim-artifact.contract-catalog` and produces or updates `pim-artifact.workflow-model`.
...
Configure identity providers and principals. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.architecture-posture`, `pim-artifact.service-map`, `pim-artifact.contract-catalog` and produces or updates `pim-artifact.security-model`.
...
Apply resilience policies. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.security-model`, `pim-artifact.compute-catalog`, `pim-artifact.integration-topology`, `pim-artifact.service-map` and produces or updates `pim-artifact.policy-catalog`.
...
Define alerts, SLOs, and CORS. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.policy-catalog`, `pim-artifact.api-catalog`, `pim-artifact.workflow-model`, `pim-artifact.service-map` and produces or updates `pim-artifact.policy-catalog`.
...
Apply governance and compliance policies. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.policy-catalog`, `pim-artifact.security-model`, `pim-artifact.data-architecture` and produces or updates `pim-artifact.policy-catalog`.
...
Map business rules and decision models. Its primary performer is `role.solution-architect`. It consumes `pim-artifact.policy-catalog`, `pim-artifact.workflow-model`, `pim-artifact.api-catalog`, `pim-artifact.service-map` and produces or updates `pim-artifact.policy-catalog`.
...
Plan deployable slice. Its primary performer is `role.cloud-platform-engineer`. It consumes None declared and produces or updates `psm-artifact.increment-plan`.
...
Create SAM stack and globals. Its primary performer is `role.cloud-platform-engineer`. It consumes `psm-artifact.deployment-strategy`, `psm-artifact.increment-plan` and produces or updates `psm-artifact.stack-scaffold`.
...
Define CFN parameters and outputs. Its primary performer is `role.cloud-platform-engineer`. It consumes `psm-artifact.stack-scaffold`, `psm-artifact.deployment-strategy` and produces or updates `psm-artifact.stack-scaffold`.
...
Configure IAM roles and policies. Its primary performer is `role.cloud-platform-engineer`. It consumes `psm-artifact.stack-scaffold`, `psm-artifact.deployment-strategy` and produces or updates `psm-artifact.security-baseline`.
...
Provision KMS, secrets, and SSM. Its primary performer is `role.cloud-platform-engineer`. It consumes `psm-artifact.security-baseline`, `psm-artifact.stack-scaffold`, `psm-artifact.deployment-strategy` and produces or updates `psm-artifact.security-baseline`.
...
Configure VPC and subnets. Its primary performer is `role.cloud-platform-engineer`. It consumes `psm-artifact.security-baseline`, `psm-artifact.deployment-strategy`, `psm-artifact.stack-scaffold`, `psm-artifact.increment-plan` and produces or updates `psm-artifact.network-identity`.
...
Define endpoints and security groups. Its primary performer is `role.cloud-platform-engineer`. It consumes `psm-artifact.network-identity`, `psm-artifact.security-baseline`, `psm-artifact.deployment-strategy` and produces or updates `psm-artifact.network-identity`.
...
Configure Cognito user pools. Its primary performer is `role.cloud-platform-engineer`. It consumes `psm-artifact.network-identity`, `psm-artifact.security-baseline`, `psm-artifact.deployment-strategy` and produces or updates `psm-artifact.network-identity`.
...
Configure clients, groups, and identity pools. Its primary performer is `role.cloud-platform-engineer`. It consumes `psm-artifact.network-identity`, `psm-artifact.security-baseline`, `psm-artifact.deployment-strategy` and produces or updates `psm-artifact.network-identity`.
...
Provision DynamoDB tables. Its primary performer is `role.cloud-platform-engineer`. It consumes `psm-artifact.network-identity`, `psm-artifact.stack-scaffold`, `psm-artifact.security-baseline`, `psm-artifact.deployment-strategy` and produces or updates `psm-artifact.storage-layer`.
...
Configure S3 buckets and policies. Its primary performer is `role.cloud-platform-engineer`. It consumes `psm-artifact.storage-layer`, `psm-artifact.network-identity`, `psm-artifact.security-baseline`, `psm-artifact.deployment-strategy`, `psm-artifact.stack-scaffold` and produces or updates `psm-artifact.storage-layer`.
...
Create SQS queues. Its primary performer is `role.cloud-platform-engineer`. It consumes `psm-artifact.storage-layer`, `psm-artifact.network-identity`, `psm-artifact.security-baseline`, `psm-artifact.deployment-strategy` and produces or updates `psm-artifact.messaging-layer`.
...
Configure EventBridge buses and rules. Its primary performer is `role.cloud-platform-engineer`. It consumes `psm-artifact.messaging-layer`, `psm-artifact.network-identity`, `psm-artifact.security-baseline`, `psm-artifact.deployment-strategy` and produces or updates `psm-artifact.event-fabric`.
...
Deploy Lambda functions. Its primary performer is `role.cloud-platform-engineer`. It consumes `psm-artifact.event-fabric`, `psm-artifact.stack-scaffold`, `psm-artifact.security-baseline`, `psm-artifact.network-identity`, `psm-artifact.deployment-strategy` and produces or updates `psm-artifact.compute-layer`.
...
Configure event sources and permissions. Its primary performer is `role.cloud-platform-engineer`. It consumes `psm-artifact.compute-layer`, `psm-artifact.event-fabric`, `psm-artifact.security-baseline`, `psm-artifact.network-identity` and produces or updates `psm-artifact.compute-layer`.
...
Configure APIs and routes. Its primary performer is `role.cloud-platform-engineer`. It consumes `psm-artifact.compute-layer`, `psm-artifact.network-identity`, `psm-artifact.security-baseline`, `psm-artifact.deployment-strategy` and produces or updates `psm-artifact.api-layer`.
...
Configure integrations and authorizers. Its primary performer is `role.cloud-platform-engineer`. It consumes `psm-artifact.api-layer`, `psm-artifact.compute-layer`, `psm-artifact.event-fabric`, `psm-artifact.network-identity`, `psm-artifact.security-baseline` and produces or updates `psm-artifact.api-layer`.
...
Deploy state machines. Its primary performer is `role.cloud-platform-engineer`. It consumes `psm-artifact.api-layer`, `psm-artifact.compute-layer`, `psm-artifact.event-fabric`, `psm-artifact.network-identity`, `psm-artifact.security-baseline` and produces or updates `psm-artifact.workflow-observability`.
...
Configure alarms and dashboards. Its primary performer is `role.cloud-platform-engineer`. It consumes `psm-artifact.workflow-observability`, `psm-artifact.compute-layer`, `psm-artifact.api-layer`, `psm-artifact.event-fabric`, `psm-artifact.network-identity` and produces or updates `psm-artifact.workflow-observability`.
...
Review project structure and generated templates. Its primary performer is `role.application-engineer`. It consumes None declared and produces or updates `artifact.generated-baseline`.
...
Establish source-control and release baseline. Its primary performer is `role.release-engineer`. It consumes `artifact.generated-baseline` and produces or updates `artifact.generated-baseline`.
...
Route structural gaps back to the PSM. Its primary performer is `role.cloud-platform-engineer`. It consumes `artifact.generated-baseline` and produces or updates `artifact.generated-baseline`.
...
Complete repository hygiene. Its primary performer is `role.application-engineer`. It consumes `artifact.generated-baseline` and produces or updates `artifact.generated-baseline`.
...
Define parameter and environment contract. Its primary performer is `role.cloud-platform-engineer`. It consumes `artifact.generated-baseline` and produces or updates `artifact.environment-contract`.
...
Configure secret references and encryption. Its primary performer is `role.security-engineer`. It consumes `artifact.generated-baseline`, `artifact.environment-contract` and produces or updates `artifact.environment-contract`, `artifact.security-record`.
...
Review IAM and deployment permissions. Its primary performer is `role.security-engineer`. It consumes `artifact.environment-contract`, `artifact.security-record`, `artifact.generated-baseline` and produces or updates `artifact.security-record`.
...
Implement repeatable build and deployment pipeline. Its primary performer is `role.release-engineer`. It consumes `artifact.security-record`, `artifact.environment-contract`, `artifact.generated-baseline` and produces or updates `artifact.environment-contract`.
...
Run reproducible build and infrastructure validation. Its primary performer is `role.quality-engineer`. It consumes `artifact.environment-contract`, `artifact.security-record`, `artifact.generated-baseline` and produces or updates `artifact.verification-evidence`.
...
Assess dependencies and security findings. Its primary performer is `role.security-engineer`. It consumes `artifact.verification-evidence`, `artifact.security-record`, `artifact.environment-contract`, `artifact.generated-baseline` and produces or updates `artifact.security-record`, `artifact.verification-evidence`.
...
Deploy to staging and execute acceptance tests. Its primary performer is `role.quality-engineer`. It consumes `artifact.security-record`, `artifact.verification-evidence`, `artifact.environment-contract`, `artifact.generated-baseline` and produces or updates `artifact.verification-evidence`.
...
Verify observability and operational signals. Its primary performer is `role.cloud-platform-engineer`. It consumes `artifact.verification-evidence`, `artifact.environment-contract`, `artifact.security-record` and produces or updates `artifact.verification-evidence`, `artifact.operations-pack`.
...
Create release, rollback, and communication plan. Its primary performer is `role.release-engineer`. It consumes `artifact.verification-evidence`, `artifact.operations-pack`, `artifact.security-record`, `artifact.environment-contract` and produces or updates `artifact.release-plan`.
...
Obtain production readiness approval. Its primary performer is `role.service-owner`. It consumes `artifact.release-plan`, `artifact.verification-evidence`, `artifact.security-record`, `artifact.operations-pack` and produces or updates `artifact.release-plan`, `artifact.security-record`.
...
Complete operations handover. Its primary performer is `role.service-owner`. It consumes `artifact.release-plan`, `artifact.security-record`, `artifact.verification-evidence`, `artifact.environment-contract`, `artifact.generated-baseline` and produces or updates `artifact.operations-pack`.
...
### Cost Model and Budget Guardrails (`e2e-artifact.cost-model`)

Demand drivers, scenario ranges, allocation tags, unit economics, budgets, anomaly thresholds, confidence, and review cadence. Kind: Artifact. Provenance: End-to-end lifecycle.

### Retrospective and Improvement Record (`e2e-artifact.improvement-record`)

Observed outcomes, process/model friction, measures, decisions, owners, experiments, reusable candidates, and no-op rationale. Kind: Artifact. Provenance: End-to-end lifecycle.

### Increment and Integrated Plan Record (`e2e-artifact.increment-record`)

Roadmap/release hypothesis, slice goal, scope, acceptance evidence, model revisions, transformation runs, forecast, and retrospective results. Kind: Artifact. Provenance: End-to-end lifecycle.
...
### Operational Evidence, Incident and Change Record (`e2e-artifact.operations-record`)

SLOs, incidents/problems, changes, capacity, cost, security, provider events, product outcomes, and learning. Kind: Artifact. Provenance: End-to-end lifecycle.
...
### Release, Recovery, Handover and Promotion Record (`e2e-artifact.release-record`)

Immutable candidate, exact model/artifact revisions, recovery plan, readiness/handover pack, approvals, deployment evidence, rollback identity, and outcome. Kind: Artifact. Provenance: End-to-end lifecycle.

### Retirement, Data-Disposition and Closure Record (`e2e-artifact.retirement-record`)

Retirement decision, migration, retention/export/deletion evidence, decommission evidence, financial closure, and retained knowledge. Kind: Artifact. Provenance: End-to-end lifecycle.

### Risk and Opportunity Register (`e2e-artifact.risk-register`)

Cause-event-effect statements, exposure, owner, treatment, trigger, review date, and evidence. Kind: Artifact. Provenance: End-to-end lifecycle.

### Feasibility and Serverless Suitability Record (`e2e-artifact.serverless-suitability`)

Compared alternatives, workload fit, assumptions, experiments, provider decision, and recommendation. Kind: Artifact. Provenance: End-to-end lifecycle.
