...
| CIM method component                   | `mde/process/definitions/cim.json` (26 TaskDefinitions)                                                                                                      |
...
| Artifact completion/readiness          | `mde/process/definitions/artifact.json` (16 TaskDefinitions)                                                                                                 |
| Integrated executable process          | `mde/process/definitions/end-to-end.json`                                                                                                                    |
| Nested lifecycle and release semantics | `mde/process/method/spem/views/lifecycle.puml`, `release-cycle.puml`, and generated conditional `WorkSequence` elements in `modriss-method-library.spem.xml` |
...
| ------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| One exhaustive analytical enactment, but no empirical enactment reported | Internal consistency and logical enactability have been tested; effectiveness, effort, usability, and scalability are not proven.            | Use the ColdChain instruments, then conduct at least two contrasting observed case studies and practitioner review.                                 |
