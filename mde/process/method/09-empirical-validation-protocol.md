...
> **Analytical pretest.** The fictional ColdChain Sentinel enactment in
> [`13-hypothetical-enactment-and-process-validation.md`](13-hypothetical-enactment-and-process-validation.md)
> has pretested task/role/product/gate coverage and corrected internal method
> defects. It is not a participant observation and does not satisfy this
> empirical protocol or answer EV-RQ1–EV-RQ6.
