...
| MR-LC-04 | Treat initiation, tailoring, organization, operations, and retirement as first-class work, not prose surrounding the modeling workflow.                                                             | MUST  | Bounded Development and Delivery concerns are phases; ongoing Operations and Maintenance is a process with entry, termination, ownership, and evidence.                                                                                                                              |
...
| MR-LC-08 | Separate planned release commitments from continuous service demand while keeping both connected to one product lifecycle and evidence system.                                                      | MUST  | Release/increment planning and the Kanban service-delivery system are distinct SPEM activities with explicit routing rules.                                                                                                                                                          |
| MR-LC-09 | Manage operational and maintenance work through a visible Kanban board with a defined workflow, WIP controls, explicit policies, service-level expectations, replenishment, and flow measures.      | MUST  | The method profile and service board expose states, WIP, policies, SLEs, item age, cycle time, throughput, blockers, and cadences.                                                                                                                                                   |
| MR-LC-10 | Distinguish maintenance purpose from class of service, and emergency temporary restoration from permanent correction.                                                                               | MUST  | Every operational item records all three decisions; temporary emergency modifications create tracked reconciliation/corrective work.                                                                                                                                                 |
| MR-LC-11 | Use Phase, Process, Activity, Stage, Substage, Iteration, and Task consistently, and synchronize Development and Delivery with Operations and Maintenance through explicit DevOps interfaces.       | MUST  | Exactly three lifecycle phases are bounded, sequential, and non-repeatable; recurring modeling and release work is typed Stage/Iteration/Activity; operations is ongoing/event-driven; and G7, feedback/change routing, retirement, and G8 are cross-process synchronization points. |
...
| MR-MG-08 | Govern capacity across planned delivery and Kanban service work without pretending that future incidents are schedulable.                              | MUST   | The method profile defines service capacity, replenishment, WIP controls, expedite policy, and how selected work enters a planned release. |
...
| Operational demand     | rare / intermittent / sustained / incident-dominated                        | Selects pull-system detail, operational capacity allocation, replenishment cadence, WIP limits, and service-level expectations. |
| Support coverage       | business hours / extended / 24×7 / follow-the-sun                           | Selects on-call ownership, escalation, hand-off, emergency authority, and evidence retention.                                   |
