...
/**
 * Compact PIM process authoring input. The process compiler separates its
...
const PIM_INPUT_ARTIFACT_IDS = {
  ...
  "pim.ph1.st1.t2": ["pim-artifact.architecture-posture", "pim-artifact.increment-plan"],
  "pim.ph1.st1.t3": ["pim-artifact.architecture-posture", "pim-artifact.increment-plan"],
  "pim.ph1.st2.t1": ["pim-artifact.architecture-posture", "pim-artifact.increment-plan"],
  "pim.ph1.st2.t2": ["pim-artifact.service-map", "pim-artifact.architecture-posture"],
  "pim.ph2.st1.t1": [
    "pim-artifact.service-map",
    "pim-artifact.architecture-posture",
    "pim-artifact.increment-plan",
  ],
  "pim.ph2.st1.t2": ["pim-artifact.contract-catalog", "pim-artifact.service-map"],
  "pim.ph2.st2.t1": [
  ...
  "pim.ph2.st2.t2": [
    "pim-artifact.data-architecture",
    "pim-artifact.contract-catalog",
    "pim-artifact.service-map",
  ],
  "pim.ph2.st2.t3": [
  ...
  "pim.ph4.st1.t2": [
    "pim-artifact.integration-topology",
    "pim-artifact.api-catalog",
    "pim-artifact.contract-catalog",
    "pim-artifact.compute-catalog",
  ],
