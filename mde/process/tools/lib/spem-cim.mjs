...
/**
 * Compact CIM process authoring input. The process compiler separates its
...
const CIM_PROCESS_PHASES_SOURCE = [
  {
    ...
    entryCriteria: ["MODRISS project created or prior CIM increment selected for evolution"],
    exitCriteria: [
      ...
      },
      {
        ...
        tasks: [
          ...
          },
          {
            ...
            entryCriteria: ["Capability drafted"],
...
const CIM_INPUT_ARTIFACT_IDS = {
  ...
  "cim.ph1.st3.t2": ["cim-artifact.strategic-intent", "cim-artifact.increment-plan"],
  "cim.ph2.st1.t1": ["cim-artifact.strategic-intent", "cim-artifact.increment-plan"],
  "cim.ph2.st1.t2": ["cim-artifact.participation-model", "cim-artifact.strategic-intent"],
  "cim.ph2.st2.t1": ["cim-artifact.participation-model", "cim-artifact.strategic-intent"],
  "cim.ph2.st2.t2": ["cim-artifact.capability-map", "cim-artifact.strategic-intent"],
  "cim.ph2.st3.t1": ["cim-artifact.capability-map", "cim-artifact.strategic-intent"],
  "cim.ph3.st1.ss1.t1": ["cim-artifact.glossary", "cim-artifact.strategic-intent"],
  "cim.ph3.st1.ss2.t1": ["cim-artifact.information-taxonomy", "cim-artifact.glossary"],
  "cim.ph3.st2.ss1.t1": [
    "cim-artifact.information-taxonomy",
    "cim-artifact.glossary",
    "cim-artifact.capability-map",
  ],
  "cim.ph3.st2.ss2.t1": ["cim-artifact.domain-structure", "cim-artifact.information-taxonomy"],
  "cim.ph3.st3.ss1.t1": [
    "cim-artifact.domain-structure",
    "cim-artifact.participation-model",
    "cim-artifact.capability-map",
  ],
  "cim.ph3.st3.ss2.t1": [
  ...
  "cim.ph4.st3.t1": [
    ...
    "cim-artifact.behavior-surface",
    "cim-artifact.process-model",
    "cim-artifact.decision-model",
  ],
  "cim.ph5.st1.t1": [
    "cim-artifact.strategic-intent",
    "cim-artifact.domain-structure",
    "cim-artifact.behavior-surface",
    "cim-artifact.context-map",
    "cim-artifact.decision-model",
  ],
  "cim.ph5.st1.t2": [
  ...
  "cim.ph5.st2.t1": [
    "cim-artifact.governance-package",
    "cim-artifact.requirements-package",
    "cim-artifact.context-map",
    "cim-artifact.domain-structure",
    "cim-artifact.decision-model",
  ...
  "cim.ph5.st3.t1": [
    "cim-artifact.transformation-contract",
    "cim-artifact.strategic-intent",
    "cim-artifact.requirements-package",
    "cim-artifact.domain-structure",
    "cim-artifact.behavior-surface",
