...
- Represent behavior and information alongside generic requirements. Select exact contracts for commands, queries, events, domain data, policies, processes, or decisions when the evidence supports them and structural requirements can be satisfied.
