...
public final class AgenticTurnService {
  ...
  public Result run(
      ...
      boolean destructiveConfirmed,
      java.util.function.BooleanSupplier cancellationRequested,
      java.util.function.Supplier<io.mehdieidi.modriss.platform.kernel.PlatformException>
          stopReason) {
    return run(
        user,
        sessionId,
  ...
  private Result run(
    ...
    io.mehdieidi.modriss.platform.kernel.PlatformException stop =
  ...
  private String contextualMessage(String sessionId, String message) {
    ...
    List<io.mehdieidi.modriss.platform.assistant.domain.memory.AssistantMemoryRecords.MessageRecord>
        history =
            memory.recentMessages(sessionId, 8).stream()
                .sorted(
                    java.util.Comparator.comparing(
                        io.mehdieidi.modriss.platform.assistant.domain.memory.AssistantMemoryRecords
                                .MessageRecord
                            ::createdAt))
                .toList();
  ...
  public record Result(
      ...
      io.mehdieidi.modriss.platform.assistant.domain.ModelCommandBatch commandBatch,
      int providerCalls,
      long promptTokens,
