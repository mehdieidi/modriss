 ...
 */
@ConfigurationProperties(prefix = "modriss.ai")
public record AiProperties(
  ...
  public io.mehdieidi.modriss.platform.assistant.provider.AssistantModelProvider
          .ProviderCapabilities
      providerCapabilities() {
    return new io.mehdieidi.modriss.platform.assistant.provider.AssistantModelProvider
        .ProviderCapabilities(
        maxCompletionTokens,
        maxPatchCreates,
        maxPatchConnections,
  ...
  public record OpenAiCompatible(String baseUrl, String apiKey, OpenAiProtocol protocol) {
    ...
    public OpenAiCompatible {
      ...
      if (protocol == null || protocol == OpenAiProtocol.AUTO) {
        protocol = OpenAiProtocol.from(System.getenv("MODRISS_AI_OPENAI_PROTOCOL"));
      }
    }
  }
  ...
  public enum OpenAiProtocol {
    ...
    public static OpenAiProtocol from(String value) {
      ...
      return switch (value.trim().toLowerCase(java.util.Locale.ROOT)) {
        ...
        default ->
            throw new IllegalArgumentException("Unsupported MODRISS_AI_OPENAI_PROTOCOL: " + value);
      };
    }
  }
  ...
  public record Models(String model, String testModel) {
    ...
    public String model(Provider provider) {
      ...
      if (selected == null || selected.isBlank()) selected = System.getenv("MODRISS_AI_MODEL");
    ...
    public String testModel(Provider provider) {
      ...
      if (selected == null || selected.isBlank()) selected = System.getenv("MODRISS_AI_TEST_MODEL");
