package io.mehdieidi.modriss.platform.assistant.persistence.memory;
...
public class SpringAiJdbcChatMemory implements AssistantChatMemory {

  private final ChatMemoryRepository repository;
  private final Map<String, List<Message>> inMemory;

  public SpringAiJdbcChatMemory() {
    this.repository = null;
    this.inMemory = new ConcurrentHashMap<>();
  }

  public SpringAiJdbcChatMemory(@Nullable JdbcTemplate jdbcTemplate) {
    this.repository =
        jdbcTemplate == null
            ? null
