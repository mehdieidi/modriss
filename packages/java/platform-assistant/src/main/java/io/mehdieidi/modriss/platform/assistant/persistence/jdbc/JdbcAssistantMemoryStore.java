...
import io.mehdieidi.modriss.platform.assistant.domain.AssistantValidationSummary;
import io.mehdieidi.modriss.platform.assistant.domain.SemanticModelPatch;
import io.mehdieidi.modriss.platform.assistant.domain.memory.AssistantMemoryRecords.ConversationSummary;
import io.mehdieidi.modriss.platform.assistant.domain.memory.AssistantMemoryRecords.MessageRecord;
import io.mehdieidi.modriss.platform.assistant.domain.memory.AssistantMemoryRecords.ProposalRecord;
import io.mehdieidi.modriss.platform.assistant.domain.memory.AssistantMemoryRecords.ThreadRecord;
...
public class JdbcAssistantMemoryStore implements AssistantMemoryStore {
  ...
  private static final TypeReference<
          List<io.mehdieidi.modriss.platform.model.application.ModelService.ModelPatchOperation>>
