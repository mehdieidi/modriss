...
public final class PsmCommand implements Callable<Integer> {
    ...
    @Option(names = "--model", required = true, description = "Input PSM XMI model file.")
    private Path model;
    ...
    public Integer call() throws Exception {
        return runner.execute(
                commandSpec,
                ProfileCommandSupport.request(repositoryRoot, "psm",
                        "psm-semantic-validation.evl", model, "AWSPSM",
                        List.of("AWSPSMENUMS", "KERNEL"), !noStructuralValidation),
