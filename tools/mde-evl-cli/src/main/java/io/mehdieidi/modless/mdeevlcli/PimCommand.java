 ...
 */
@Command(name = "pim", mixinStandardHelpOptions = true,
...
public final class PimCommand implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        return runner.execute(
                commandSpec,
                ProfileCommandSupport.request(repositoryRoot, "pim",
                        "pim-semantic-validation.evl", model, "PIM",
                        List.of("KERNEL"), !noStructuralValidation),
