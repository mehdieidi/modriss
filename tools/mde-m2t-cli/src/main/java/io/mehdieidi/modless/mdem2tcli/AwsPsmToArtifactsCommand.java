...
import io.mehdieidi.modless.mde.generation.EgxGenerationReportWriter;
import io.mehdieidi.modless.mde.generation.EgxGenerationRequest;
import io.mehdieidi.modless.mde.generation.EpsilonEgxGenerator;
import io.mehdieidi.modless.mde.generation.GenerationDiagnostic;
...
public final class AwsPsmToArtifactsCommand implements Callable<Integer> {
    ...
    @Option(names = "--repo-root", required = true, description = "Repository root containing mde/metamodels and mde/generation.")
    private Path repositoryRoot;

    @Option(names = "--source-model", required = true, description = "Input AWS PSM XMI model file.")
    private Path sourceModel;

    @Option(names = "--output-dir", required = true, description = "Directory where generated project artifacts are written.")
    private Path outputDirectory;

    @Option(names = "--fail-if-output-not-empty", description = "Fail before generation when the output directory already contains files.")
