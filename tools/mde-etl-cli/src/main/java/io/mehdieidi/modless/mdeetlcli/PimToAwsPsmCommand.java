...
public final class PimToAwsPsmCommand implements Callable<Integer> {
    ...
    @Option(names = "--repo-root", required = true, description = "Repository root containing mde/metamodels and mde/transformations.")
    ...
    public Integer call() throws Exception {
        ...
        EtlExecutionRequest request = PimToAwsPsmDefaults.request(
