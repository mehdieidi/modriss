...
| `BuildPowerShellScript`             | `AWSPSM2ART_BuildPowerShellScript`             | `scripts/build.ps1.egl`                   | `SCRIPT`                | `EpsilonEgxGeneratorTest` | PowerShell build script is generated, parsed, and executes the generated Go tests and Linux bootstrap builds on Windows.                                                                                                                     |
...
| `EmulatorEnvPowerShellScript`       | `AWSPSM2ART_EmulatorEnvPowerShellScript`       | `scripts/emulator-env.ps1.egl`            | `SCRIPT`                | `EpsilonEgxGeneratorTest` | PowerShell equivalent configures the selected Floci/LocalStack endpoint and local AWS credentials.                                                                                                                                           |
| `EmulatorPreflightPowerShellScript` | `AWSPSM2ART_EmulatorPreflightPowerShellScript` | `scripts/emulator-preflight.ps1.egl`      | `SCRIPT`                | `EpsilonEgxGeneratorTest` | PowerShell preflight checks AWS emulator connectivity and Docker availability for Lambda execution.                                                                                                                                          |
| `EmulatorWorkflowPowerShellScript`  | `AWSPSM2ART_EmulatorWorkflowPowerShellScript`  | `scripts/emulator-workflow.ps1.egl`       | `SCRIPT`                | `EpsilonEgxGeneratorTest` | PowerShell probe deploys generated ASL through the native Step Functions API and verifies execution success when SAM workflow materialization is unavailable in an emulator.                                                                 |
...
- `scripts/build.egl`
- `scripts/build.ps1.egl`
- `scripts/deploy.egl`
- `scripts/emulator-env.egl`
- `scripts/emulator-env.ps1.egl`
- `scripts/emulator-preflight.ps1.egl`
- `scripts/emulator-workflow.ps1.egl`
