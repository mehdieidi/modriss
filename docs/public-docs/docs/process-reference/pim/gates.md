# PIM modeling: gates and milestones

This page documents the **SPEM Milestone with MODRISS evidence and authority extensions** elements used by the PIM modeling process. It is generated from the canonical executable definition, so the names and identifiers match the API and process interface. The explanation adds practical teaching around the normative data.
...
| --------------- | ----------------------- | ----------: | ----------------: |
| pim.m1.evl-gate | PIM EVL validation gate |           0 |                 0 |

## Detailed gates and milestones

## PIM EVL validation gate

<small>Milestone: `pim.m1.evl-gate` · phase/activity `pim.ph6`</small>
