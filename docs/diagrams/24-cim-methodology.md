...
The coverage matrix (`mde/methodology/coverage-matrix/cim-coverage.json`) maps every CIM metamodel concept to one or more **task IDs** (e.g. `cim.ph3.st1.ss1.t1`). Rows group by phase; columns are EClasses and EEnums.
