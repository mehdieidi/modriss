# Capability-Increment Process Activity Diagram
...
[full-lifecycle development process](https://github.com/mehdieidi/modriss/blob/main/mde/process/software-development-process.md).
