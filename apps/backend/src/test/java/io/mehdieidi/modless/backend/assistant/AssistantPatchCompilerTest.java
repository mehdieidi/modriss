...
class AssistantPatchCompilerTest {
    ...
    void compilesStableIdAttributeUpdateWithoutModelAuthoredJsonPointer() throws Exception {
        ...
        SemanticModelPatch patch = new SemanticModelPatch(List.of(
                new SemanticModelPatch.Operation(SemanticModelPatch.OperationType.SET_ATTRIBUTE,
                        "service-1", "Service", new TextNode("New"), null, "name")));
    ...
    void rejectsModelAuthoredPointerLikeAttributeNames() throws Exception {
        ...
        SemanticModelPatch patch = new SemanticModelPatch(List.of(
                new SemanticModelPatch.Operation(SemanticModelPatch.OperationType.SET_ATTRIBUTE,
                        "service-1", "Service", new TextNode("bad"), null, "../secret")));
