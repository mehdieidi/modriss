...
public interface AssistantModelProvider {
    ...
    /**
     * Produces a schema-converted semantic patch. Providers that do not support structured
     * output remain explain-only.
     *
     ...
     */
    record AssistantPrompt(AssistantModelRole role, String system, String user,
