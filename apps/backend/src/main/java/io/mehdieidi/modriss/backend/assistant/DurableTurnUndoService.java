...
import io.mehdieidi.modriss.platform.model.application.ModelService.ModelPatchOperation;
...
public final class DurableTurnUndoService {
  ...
  public DurableTurnUndoService(
      AssistantTurnStore turns, ModelService models, ObjectMapper mapper, ModrissMetrics metrics) {
    this.turns = turns;
    this.models = models;
    this.mapper = mapper;
