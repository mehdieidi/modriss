...
export const el = {
  ...
  profileRailBtn: document.getElementById("profileRailBtn"),
  profileRailMenu: document.getElementById("profileRailMenu"),
  ...
  canvasFocusBackBtn: document.getElementById("canvasFocusBackBtn"),
  canvasMinimap: document.getElementById("canvasMinimap"),
  canvasMinimapSvg: document.getElementById("canvasMinimapSvg"),
  canvasMinimapWindow: document.getElementById("canvasMinimapWindow"),
  ...
  mobileDockSaveBtn: document.getElementById("mobileDockSaveBtn"),
  mobileDockSaveLabel: document.getElementById("mobileDockSaveLabel"),
  ...
  mobileModelLevelSwitcher: document.getElementById("mobileModelLevelSwitcher"),
  mobileModelLevelToggle: document.getElementById("mobileModelLevelToggle"),
  mobileModelLevelLabel: document.getElementById("mobileModelLevelLabel"),
  mobileModelLevelMenu: document.getElementById("mobileModelLevelMenu"),
  ...
  authContinueLoginBtn: document.getElementById("authContinueLoginBtn"),
  ...
  synchronizationConflictOverlay: document.getElementById("synchronizationConflictOverlay"),
  synchronizationConflictTitle: document.getElementById("synchronizationConflictTitle"),
  synchronizationConflictProgress: document.getElementById("synchronizationConflictProgress"),
  synchronizationConflictSummary: document.getElementById("synchronizationConflictSummary"),
  synchronizationConflictMeta: document.getElementById("synchronizationConflictMeta"),
  synchronizationConflictDiff: document.getElementById("synchronizationConflictDiff"),
  synchronizationConflictChoices: document.getElementById("synchronizationConflictChoices"),
  synchronizationConflictBulkAction: document.getElementById("synchronizationConflictBulkAction"),
  synchronizationConflictCloseBtn: document.getElementById("synchronizationConflictCloseBtn"),
  synchronizationConflictPreviousBtn: document.getElementById("synchronizationConflictPreviousBtn"),
  synchronizationConflictNextBtn: document.getElementById("synchronizationConflictNextBtn"),
  synchronizationConflictApplyBtn: document.getElementById("synchronizationConflictApplyBtn"),
